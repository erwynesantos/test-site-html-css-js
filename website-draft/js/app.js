...
gsap.from(".promo-title", {y: 800, duration: 1}).delay(0.5)
gsap.from(".promo-info", {y: 800, duration: 1.5, ease: Power2.easeInOut}).delay(0.3)
...
gsap.from(".social-icons img", {scrollTrigger:".social-icons img", opacity: 0, duration: 1.5})


gsap.from(".history", {scrollTrigger:".history", opacity:0, y: 800, duration: 0.5, ease: Power2.easeInOut})