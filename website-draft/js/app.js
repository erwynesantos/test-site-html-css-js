...
//gsap.from(".history-text", {scrollTrigger:".history-text", opacity:0, y: 800, duration: 0.8, ease: Power2.easeInOut})
gsap.from("#history-id", {opacity:0, y: 800, duration: 0.8, ease: Power2.easeInOut})
